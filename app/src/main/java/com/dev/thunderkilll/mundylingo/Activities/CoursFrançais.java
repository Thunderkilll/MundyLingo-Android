...
public class CoursFrançais extends AppCompatActivity {

    public String url = IPadress + "/miniProjetWebService/Langue/cours/selectCourParLangue.php?langue=1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cours_fr);


        recyclerView = findViewById(R.id.recycler_view_fr);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (levelID > ConvertToInt(currentUser.getLevelFr())) {
                    Toast.makeText(CoursFrançais.this, "  your level is low for this course please finish the level first ", Toast.LENGTH_SHORT).show();

                } else {
                    //redirect to cours details

                    Intent intent = new Intent(CoursFrançais.this, ConjugaisonDetailActivity.class);

...
public class CoursEnglishActivity extends AppCompatActivity {

    public String url = IPadress + "/miniProjetWebService/Langue/cours/selectCourParLangue.php?langue=2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cours_english);
        recyclerView = findViewById(R.id.recycler_view_eng);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (levelID > ConvertToInt(currentUser.getLevelEng())) {
                    Toast.makeText(CoursEnglishActivity.this, "  your level is low for this course please finish the level first ", Toast.LENGTH_SHORT).show();

                } else {
                    //redirect to cours details

                    Intent intent = new Intent(CoursEnglishActivity.this, ConjugaisonDetailActivity.class);

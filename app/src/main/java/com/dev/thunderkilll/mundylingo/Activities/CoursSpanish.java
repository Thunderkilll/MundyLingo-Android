...
public class CoursSpanish extends AppCompatActivity {

    public String url = IPadress + "/miniProjetWebService/Langue/cours/selectCourParLangue.php?langue=4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cours_spanish);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (levelID > ConvertToInt(currentUser.getLevelSpan())) {
                    Toast.makeText(CoursSpanish.this, "  your level is low for this course please finish the level first ", Toast.LENGTH_SHORT).show();

                } else {
                    //redirect to cours details

                    Intent intent = new Intent(CoursSpanish.this, ConjugaisonDetailActivity.class);

...
public class MapSP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //calling UI Elements from layout
        //ImageButtons
        lvl1 = findViewById(R.id.splevel1);
        lvl2 = findViewById(R.id.splevel2);
        lvl3 = findViewById(R.id.splevel3);
        lvl4 = findViewById(R.id.splevel4);
        lvl5 = findViewById(R.id.splevel5);
        btn_exit = findViewById(R.id.spbtn_exit);
         //partie detail popup

        img_background = findViewById(R.id.spImg_background);
        detail_blue_background = findViewById(R.id.spdetail_blue_background);
        txt_welcome_details = findViewById(R.id.sptxt_welcome_details);
        txt_w_on_it = findViewById(R.id.sptxt_w_on_it);
        btn_start_lvl = findViewById(R.id.spbtn_start_lvl);
